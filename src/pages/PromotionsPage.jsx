...
const plans = [
  {
    ...
    price: 5000,
    oldPrice: 7000,
    devices: '+ 1 boisson offerte',
    features: [
      'Livraison gratuite 2x',
      '- 10% sur tous les achats',
      '2 Bubbles Tea offerts',
      'Support prioritaire',
    ],
    highlight: false,
  ...
  },
  {
    ...
    price: 12000,
    oldPrice: 15000,
    devices: '+ 2 boissons offertes',
    features: [
      'Toutes les livraisons gratuites',
      '- 25% sur tous les achats',
      '2 Bubbles Tea offerts par semaine',
      'Support prioritaire',
    ],
    highlight: true,
...
},
{
    ...
    price: 20000,
    oldPrice: 25000,
    devices: '+ 3 boissons offertes',
    features: [
      'Toutes les livraisons gratuites',
      'Livraison express +',
      '- 50% sur tous les achats',
      '3 Bubbles Tea offerts par semaine',
    ],
    highlight: false,
